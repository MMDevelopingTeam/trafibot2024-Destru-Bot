...
// const launchBotColorBypass = async (proxy, id, name_model, username, password, index, idRegisterCompBotContainer, isFollow) => {
...
const launchBotColorBypass = async (proxy, id, name_model, username, password, index, idRegisterCompBotContainer, isFollow, promotionMessage) => {
...
module.exports = {launchBotColorBypass}